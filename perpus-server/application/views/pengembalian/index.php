<script>
    $(function(){
        ...
        $("#denda").click(function(){
            var denda=$("#denda").val();
            var tgl_kembali=$("#kembali").val(data[2]);
            var hari_ini=new Date().getDate();

            var selisih = (tgl_kembali);
            if (denda=="Y") {
                //code
                $("#nominal").val(selisih);
                ...
                if (nominal=="") {
                    ...
                    $.ajax({
                        ...
                        success:function(html){
                            console.log(html);// untuk menciptakan console pada html atau inspeksi html
