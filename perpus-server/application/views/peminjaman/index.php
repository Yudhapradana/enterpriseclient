        ...
        $("#simpan").click(function(){
            ...
            if (nis=="") {
                ...
                $.ajax({
                    ...
                    type:"POST",
                    //data:{kode_buku:nomer,pinjam:pinjam,kembali:kembali,nis:nis,jumlah:jumlah},
...
<div class="panel panel-info">
    ...
    <div class="panel-body">
        ...
        <form class="form-inline" action="<?php echo site_url('peminjaman/stok_kurang');?>" method="post"">
            <div class="form-group">
                <label>Kode Buku</label>
                <input type="text" class="form-control" placeholder="  Kode Buku" id="kode" name="kode">
            </div>
            <div class="form-group">
        ...
        <form class="form-horizontal" action="<?php echo site_url('peminjaman/simpan');?>" method="post">
            <div class="col-md-6">
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <input type="text" id="pinjam" name="pinjam" class="form-control" value="<?php echo $tanggalpinjam;?>">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-lg-7">
                        <select name="nis" class="form-control" id="nis">
                            ...
                            <option value="<?php echo $user->nis;?>"><?php echo $user->nis;?> </option>
                            <?php endforeach;?>
