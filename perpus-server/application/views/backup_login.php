            ...
            <div class="navbar navbar-default">
                ...
                <div class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="<?php echo site_url('user');?>"><i class="glyphicon glyphicon-log-in"></i> User Page</a></li>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover">          
                                <?php foreach($terbaru as $row ):?>
                                    ...
                                    <td><a href="<?php echo site_url('buku/details/'.$row->kode_buku);?>"> <img src="<?php echo base_url('assets/img/'.$row->image);?>" height="100px" width="100px">
                                    </a></td>
                                <?php endforeach;?>
